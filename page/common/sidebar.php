...
$level_admin = array('Administrator', 'Admin');
$level_engineer = array('Administrator', 'Admin', 'Engineer');
?>
...
<?php
if (in_array($userData['user_role'], $level_engineer)) {
?>
					...
					<li class="nav-item<?php if ($p == 'kirim') { echo ' active'; } ?>"><a href="kirim"><i class="feather icon-send"></i><span class="menu-title" data-i18n="Kirim">Submit Data</span></a></li>
					<li class="nav-item<?php if ($p == 'logkirimdata') { echo ' active'; } ?>"><a href="logkirimdata"><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Log Kirim Data">Log Kirim Data</span></a></li>
					<!--
...
?>
<?php
if (in_array($userData['user_role'], $level_admin)) {
?>			
					...
					<li><a href="#"><i class="feather icon-database"></i><span class="menu-title" data-i18n="Data Master">Data Master</span></a>
						<ul class="menu-content">
							<li<?php if ($p == 'parameter') { echo ' class="active"'; } ?>><a href="parameter"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Parameter">Parameter</span></a></li>
						</ul>
					</li>
<?php
}
