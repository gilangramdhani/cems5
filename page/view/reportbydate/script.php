		...
		$.ajax({
			...
			success : function(data) {
				...
				$('#datatable').DataTable({
					...
					'ajax' : 'page/view/<?php echo $p; ?>/action/ssp.php?q='+q+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm
				});
				...
				$('#datatable2').DataTable({
					...
					'ajax' : 'page/view/<?php echo $p; ?>/action/ssp2.php?q='+q+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm
				});
				if (cat != 'all') {
					var all_options = {
						series: [],
					...
					$.getJSON('page/view/<?php echo $p; ?>/action/data.php?q='+q+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm, function(response) {
				...
				if (cat == 'all') {
					...
					$.getJSON('page/view/<?php echo $p; ?>/action/data.php?q='+q+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm, function(response) {
						...
						all_chart.updateOptions({
							...
							colors: ['#7367f0','#28c76f','#ff9f43','#00cfe8','#ff0000','#ffff00']
						});
					});
				}
			}
