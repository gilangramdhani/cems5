		...
		$.ajax({
			...
			success : function(data) {
				...
				$('#datatable').DataTable({
					...
					'ajax' : 'page/view/<?php echo $p; ?>/action/ssp.php?tahun='+tahun+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm
				});
				...
				$('#datatable2').DataTable({
					...
					'ajax' : 'page/view/<?php echo $p; ?>/action/ssp2.php?tahun='+tahun+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm
				});
				if (cat != 'all') {
					var all_options = {
						series: [],
					...
					$.getJSON('page/view/<?php echo $p; ?>/action/data.php?tahun='+tahun+'&cerobong='+cerobong+'&cat='+cat+'&prm='+prm, function(response) {
