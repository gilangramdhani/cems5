		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Grafik rata - rata data pada tahun <?php echo $tahun; ?></h4>
					<div class="heading-elements">
						<ul class="list-inline mb-0">
							<li><a class="btn btn-icon btn-flat-success" href='excel.php?p=reportbyyear&tahun=<?php echo $_POST['tahun']; ?>&cerobong=<?php echo $_POST['cerobong']; ?>&cat=<?php echo $_POST['cat']; ?>&prm=<?php echo $prm; ?>'><i class="fa fa-file-excel-o"></i> Download .xls file</a></li>
						</ul>
					</div>
				</div>
