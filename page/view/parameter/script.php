	...
	function fetch_db() {
		...
		$('#datatable').DataTable({
			...
			'columnDefs' : [{
				...
				'data' : 5,
				'render' : function (data, type, row, meta) {
					return '<div class="text-center"><span style="background-color: '+data+';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>';
				}
			}, {
				'targets' : 6,
				'data' : 6,
				'render' : function (data, type, row, meta) {
					if (data == 'active') {
						return '<div class="text-center"><span class="badge badge-success">Aktif</span></div>';
					}
					if (data == '') {
						return '<div class="text-center"><span class="badge badge-danger">Tidak Aktif</span></div>';
					}
				}
			}, {
				'targets' : 7,
