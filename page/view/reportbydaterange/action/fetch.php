		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Grafik rata - rata data pada tanggal <?php echo tanggal($fromdate); ?><br>sampai tanggal <?php echo tanggal($todate); ?></h4>
					<div class="heading-elements">
						<ul class="list-inline mb-0">
							<li><a class="btn btn-icon btn-flat-success" href='excel.php?p=reportbydaterange&fromdate=<?php echo $_POST['fromdate']; ?>&todate=<?php echo $_POST['todate']; ?>&cerobong=<?php echo $_POST['cerobong']; ?>&cat=<?php echo $_POST['cat']; ?>&prm=<?php echo $prm; ?>'><i class="fa fa-file-excel-o"></i> Download .xls file</a></li>
						</ul>
					</div>
				</div>
