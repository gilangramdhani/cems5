...
<html class="loading" lang="en" data-textdirection="ltr">
	...
	<body class="vertical-layout vertical-menu-modern semi-dark-layout 1-column  navbar-floating footer-static bg-full-screen-image blank-page blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column" data-layout="semi-dark-layout">
							...
							<div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
								<div class="card-content">
									<div class="card-body text-center">
										...
										<h2 class="mt-1 mb-0">Multiple Login Detected</h2>
										<!--
										<p class="p-3">
										...
										-->
										<br>
										<button type="button" class="verify_btn btn btn-primary" action="continue">Continue</button>
										<button type="button" class="verify_btn btn btn-danger" action="exit">Exit</button>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="page/view/double/script.js"></script>
	</body>
</html>